...
async function main() {
  ...
  assert.strictEqual(result.status, "accepted-by-master");
  ...
  // Test: second user gets a different id (postgres replication sample)
  ...
  assert.strictEqual(result2.status, "accepted-by-master");
