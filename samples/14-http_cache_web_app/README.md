...
Express web sample application using `@xtaskjs/cache` for browser-facing HTTP cache headers and rendered views.
...
From this folder: `samples/14-http_cache_web_app`.
...
- `HttpCacheService` injected into a controller for manual header composition examples.
